...
{{< grid/section-container id="posters" class="featured-section-row text-center featured-section-row-dark-bg" >}}
  {{< events/poster_display event="saam-mobility" year="2021" title="Posters" source="keynote" imageRoot="/2021/saam-mobility/images/posters/" subpage="posters" displayLearnMore="true" />}}
{{</ grid/section-container >}}
